//! Integration tests for DX-Machine format

use serializer::machine::{
    DxFormat, DxMachineBuilder, DxMachineHeader, DxMachineSlot, FLAG_HAS_HEAP, FLAG_LITTLE_ENDIAN,
...
fn test_builder_simple_struct() {
    ...
    let mut builder = DxMachineBuilder::new(&mut buffer, 13, 2);
...
fn test_multiple_strings() {
    let mut buffer = Vec::new();
    let mut builder = DxMachineBuilder::new(&mut buffer, 0, 3);
...
fn test_format_detection() {
    let mut buffer = Vec::new();
    let builder = DxMachineBuilder::new(&mut buffer, 0, 0);
    builder.finish();
...
fn test_mixed_inline_heap() {
    let mut buffer = Vec::new();
    let mut builder = DxMachineBuilder::new(&mut buffer, 8, 3);
...
fn test_roundtrip_simple() {
    // Serialize
    let mut buffer = Vec::new();
    let mut builder = DxMachineBuilder::new(&mut buffer, 12, 1);
...
fn test_zero_values() {
    let mut buffer = Vec::new();
    let mut builder = DxMachineBuilder::new(&mut buffer, 21, 0);
...
fn test_max_values() {
    ...
    let mut builder = DxMachineBuilder::new(&mut buffer, 22, 0);
