...
fn main() {
    ...
    println!(
        ...
        counter
            .count("Our_favorite_hikes_together", ModelType::Gpt4o)
            .count
    );
    println!(
        "'Our favorite hikes together' = {} tokens",
        counter
            .count("Our favorite hikes together", ModelType::Gpt4o)
            .count
    );
    println!();
    ...
    println!(
        ...
        counter
            .count("task=Our_favorite_hikes", ModelType::Gpt4o)
            .count
    );
    println!(
        "'task=\"Our favorite hikes\"' = {} tokens",
        counter
            .count("task=\"Our favorite hikes\"", ModelType::Gpt4o)
            .count
    );
    println!(
        "'task='Our favorite hikes'' = {} tokens",
    ...
    println!(
        "'[a b c]' = {} tokens",
        counter.count("[a b c]", ModelType::Gpt4o).count
    );
    println!(
        "'(a b c)' = {} tokens",
        counter.count("(a b c)", ModelType::Gpt4o).count
    ...
    println!(
        ...
        format!("{}, {}", row1, row2),
        counter
            .count(&format!("{}, {}", row1, row2), ModelType::Gpt4o)
            .count
    );
    println!(
        "semicolon:   '{}' = {} tokens",
    ...
    println!(
        ...
        counter
            .count("hikes:20(id name dist)", ModelType::Gpt4o)
            .count
    );
    println!(
        "'hikes[20]{{id,name,dist}}:' = {} tokens",
    ...
    println!(
        "'@/api/' = {} tokens",
        counter.count("@/api/", ModelType::Gpt4o).count
    );
    println!(
        "'@2025-01-15T' = {} tokens",
    ...
    println!(
        "'@@' (double) = {} tokens",
        counter.count("@@", ModelType::Gpt4o).count
    );
    println!();
    ...
    println!(
        "',row' = {} tokens",
        counter.count(",row", ModelType::Gpt4o).count
    );
    println!();
    ...
    println!(
        "'2025-01-15' = {} tokens",
        counter.count("2025-01-15", ModelType::Gpt4o).count
    );
    println!(
        "'20250115' = {} tokens",
        counter.count("20250115", ModelType::Gpt4o).count
    );
    println!(
        "'2025/01/15' = {} tokens",
        counter.count("2025/01/15", ModelType::Gpt4o).count
    ...
    println!(
        "'true' = {} tokens",
        counter.count("true", ModelType::Gpt4o).count
    );
    println!(
        "'false' = {} tokens",
        counter.count("false", ModelType::Gpt4o).count
    );
    println!(
        "'null' = {} tokens",
        counter.count("null", ModelType::Gpt4o).count
    );
    println!(
        "'none' = {} tokens",
        counter.count("none", ModelType::Gpt4o).count
    );
    println!(
        "'~' = {} tokens",
        counter.count("~", ModelType::Gpt4o).count
...
hikes:3(id name distanceKm companion wasSunny)[1 "Blue Lake Trail" 7.5 ana true, 2 "Ridge Overlook" 9.2 luis false, 3 "Wildflower Loop" 5.1 sam true]"#;
    ...
    println!(
        "TOON:           {} tokens",
        counter.count(toon, ModelType::Gpt4o).count
    );
    println!(
    ...
    println!(
        "DX quotes:      {} tokens",
        counter.count(dx_quotes, ModelType::Gpt4o).count
    );
    println!();
  ...
  2025-01-15T10:26:47Z,warn,/api/payment,429"#;
    ...
    println!(
        "TOON logs:    {} tokens",
        counter.count(toon_logs, ModelType::Gpt4o).count
    );
    println!(
        "DX logs:      {} tokens",
...
hikes[20]{id,name,distanceKm,elevationGain,companion,wasSunny,rating}:
  ...
  20,Thunder Pass,18.2,1400,david,true,5.0"#;
    ...
    println!(
        "DX current: {} tokens",
        counter.count(dx_current, ModelType::Gpt4o).count
    );
    println!();
  ...
  group: hiking_club"#;
    ...
    println!(
        "Context - TOON: {} tokens",
        counter.count(toon_context, ModelType::Gpt4o).count
    );
    println!(
        "Context - DX:   {} tokens",
        counter.count(dx_context, ModelType::Gpt4o).count
    );
    println!();
    ...
    println!(
        "Friends - TOON: {} tokens",
        counter.count(toon_friends, ModelType::Gpt4o).count
    );
    println!(
        "Friends - DX:   {} tokens",
        counter.count(dx_friends, ModelType::Gpt4o).count
    );
    println!();
    ...
    println!(
        "'1' = {} tokens",
        counter.count("1", ModelType::Gpt4o).count
    );
    println!(
        "'0' = {} tokens",
        counter.count("0", ModelType::Gpt4o).count
    );
    ...
    println!(
        "'ana 1 4.5' = {} tokens",
        counter.count("ana 1 4.5", ModelType::Gpt4o).count
    );
    println!(
    ...
    println!(
        "'ana 0 4.5' = {} tokens",
        counter.count("ana 0 4.5", ModelType::Gpt4o).count
    );
    println!();
    ...
    println!(
        "comma-space: {} tokens",
        counter.count(row_comma, ModelType::Gpt4o).count
    );
    println!(
        "semicolon:   {} tokens",
        counter.count(row_semi, ModelType::Gpt4o).count
    );
    println!(
        "colon:       {} tokens",
        counter.count(row_colon, ModelType::Gpt4o).count
    );
    println!();
    ...
    println!(
        "true/false: {} tokens",
        counter.count(hikes_bool, ModelType::Gpt4o).count
    );
    println!(
        "1/0:        {} tokens",
        counter.count(hikes_num, ModelType::Gpt4o).count
    );
    println!();
...
hikes:20(id name distanceKm elevationGain companion wasSunny rating)[1 Blue_Lake_Trail 7.5 320 ana 1 4.5, 2 Ridge_Overlook 9.2 540 luis 0 4.2, 3 Wildflower_Loop 5.1 180 sam 1 4.8, 4 Summit_Peak 12.3 890 maria 1 4.9, 5 Canyon_View 8.7 420 carlos 0 4.1, 6 Forest_Path 4.2 150 ana 1 4.6, 7 Mountain_Ridge 15.1 1100 luis 1 4.7, 8 Valley_Trail 6.8 280 sam 0 4.3, 9 Lakeside_Walk 3.5 90 maria 1 4.4, 10 Alpine_Meadow 11.2 650 carlos 1 4.8, 11 Sunset_Point 5.8 220 emma 1 4.5, 12 Eagle_Nest 14.2 980 david 0 4.6, 13 River_Bend 4.5 120 sophia 1 4.2, 14 Pine_Grove 7.1 340 ana 0 4.3, 15 Rocky_Summit 16.5 1250 luis 1 4.9, 16 Meadow_Loop 3.2 80 sam 1 4.1, 17 Cliff_Edge 9.8 560 maria 0 4.7, 18 Waterfall_Trail 8.3 410 carlos 1 4.8, 19 Hidden_Lake 10.5 720 emma 1 4.6, 20 Thunder_Pass 18.2 1400 david 1 5.0]"#;
    ...
    println!(
        "DX with 1/0:   {} tokens",
        counter.count(dx_with_10, ModelType::Gpt4o).count
    );
    ...
    println!(
        "'pre /api/' = {} tokens",
        counter.count("pre /api/", ModelType::Gpt4o).count
    );
    println!(
        "'p /api/' = {} tokens",
        counter.count("p /api/", ModelType::Gpt4o).count
    );
    println!();
  ...
  2025-01-15T10:26:47Z,warn,/api/payment,429,5,Rate limit exceeded"#;
    ...
    println!(
        "DX comma-space:    {} tokens",
        counter.count(dx_comma, ModelType::Gpt4o).count
    );
    println!(
        "DX colon sep:      {} tokens",
        counter.count(dx_colon, ModelType::Gpt4o).count
    );
    println!(
    ...
    for pfx in prefixes {
        ...
        println!(
            "'{}' = {} tokens",
            test,
            counter.count(&test, ModelType::Gpt4o).count
        );
    }
    println!();
