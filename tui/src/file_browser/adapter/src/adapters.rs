...
impl From<&fb_emulator::Emulator> for Adapters {
	fn from(value: &fb_emulator::Emulator) -> Self { value.kind.either_into() }
}

impl From<fb_emulator::Brand> for Adapters {
	fn from(value: fb_emulator::Brand) -> Self {
		use fb_emulator::Brand as B;
...
impl From<fb_emulator::Unknown> for Adapters {
	fn from(value: fb_emulator::Unknown) -> Self {
		use Adapter as A;
