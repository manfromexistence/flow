...
use fb_fs::FsScheme;
use fb_shared::scheme::SchemeLike;

use crate::{Path, cached_field};

pub struct Scheme {
	inner: fb_shared::scheme::Scheme,
...
impl Deref for Scheme {
	type Target = fb_shared::scheme::Scheme;

	fn deref(&self) -> &Self::Target { &self.inner }
}

impl Scheme {
	pub fn new(scheme: impl Into<fb_shared::scheme::Scheme>) -> Self {
