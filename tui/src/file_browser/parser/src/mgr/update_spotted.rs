...
use fb_binding::{FileRef, elements::Renderable};
use fb_shared::{Id, event::ActionCow};
...
#[derive(Clone, Debug)]
pub struct SpotLock {
	pub url:  fb_shared::url::UrlBuf,
	pub cha:  fb_fs::cha::Cha,
	pub mime: String,
...
impl SpotLock {
	...
	pub fn table(&self) -> Option<&fb_binding::elements::Table> {
	...
	pub fn table_mut(&mut self) -> Option<&mut fb_binding::elements::Table> {
