...
use fb_shared::{scheme::Encode as EncodeScheme, strand::ToStrand, url::{Url, UrlBuf}};
...
impl ConfirmCfg {
	...
	pub fn trash(urls: &[fb_shared::url::UrlBuf]) -> Self {
		Self::new(
	...
	pub fn delete(urls: &[fb_shared::url::UrlBuf]) -> Self {
		Self::new(
