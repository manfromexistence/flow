...
> [!IMPORTANT]
> If you're using a stable release of dx instead of the newest nightly build, make sure you're checking these files out from [the `shipped` tag][shipped], not the newest `main` branch.

This directory contains the default configuration files for dx:
...
These files are already included with dx when you install the release, so you don't need to manually download or copy them to your dx configuration directory.
...
[shipped]: https://github.com/sxdx/dx/tree/shipped
...
- [Configuration documentation](https://dx-rs.github.io/docs/configuration/overview)
- [Flavors documentation](https://dx-rs.github.io/docs/flavors/overview)
