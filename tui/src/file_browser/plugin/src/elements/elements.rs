...
use fb_binding::{Composer, ComposerGet, ComposerSet, Permit, PermitRef, elements::{Line, Rect, Span, Wrap}, runtime};
use fb_config::{LAYOUT, YAZI};
use fb_proxy::AppProxy;
use fb_shared::replace_to_printable;
use fb_shim::ratatui::line_count;
...
pub fn compose() -> Composer<ComposerGet, ComposerSet> {
	...
	fb_binding::elements::compose(get, set)
}
