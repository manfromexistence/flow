use anyhow::Result;
use fb_config::popup::{ConfirmCfg, InputCfg};
use fb_dds::Pubsub;
use fb_fs::{File, FilesOp};
use fb_macro::{act, err, ok_or_not_found, succ};
use fb_parser::mgr::RenameOpt;
use fb_proxy::{ConfirmProxy, InputProxy, MgrProxy};
use fb_shared::{Id, data::Data, url::{UrlBuf, UrlLike}};
