...
impl Deref for Tab {
	type Target = fb_core::tab::Tab;

	fn deref(&self) -> &Self::Target { &self.inner }
}

impl Tab {
	pub(super) fn make(inner: &fb_core::tab::Tab) -> mlua::Result<AnyUserData> {
