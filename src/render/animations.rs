...
impl ChatApp {
    ...
    #[allow(dead_code)]
    pub fn theme_accent_color(&self) -> ratatui::style::Color {
        self.theme.accent
    }

    /// Helper: get theme fg as ratatui Color
    #[allow(dead_code)]
    pub fn theme_fg_color(&self) -> ratatui::style::Color {
        self.theme.fg
    }
    ...
    #[allow(dead_code)]
    pub fn render_matrix_animation(&self, frame: &mut ratatui::Frame) {
        let area = frame.area();
        self.render_matrix_animation_in_area(area, frame);
    }

    pub fn render_matrix_animation_in_area(&self, area: Rect, frame: &mut ratatui::Frame) {
    ...
    #[allow(dead_code)]
    pub fn render_train_animation(&self, frame: &mut ratatui::Frame) {
        let area = frame.area();
        self.render_train_animation_in_area(area, frame);
    }

    pub fn render_train_animation_in_area(&self, area: Rect, frame: &mut ratatui::Frame) {
        let bg_color = self.theme_bg_color();
        let elapsed_ms = self
            .animation_start_time
    ...
    #[allow(dead_code)]
    pub fn render_animation_placeholder(
        &self,
        area: Rect,
...
impl ChatApp {
    pub fn render_confetti_animation_in_area(&self, area: Rect, frame: &mut ratatui::Frame) {
    ...
    pub fn render_gameoflife_animation_in_area(&self, area: Rect, frame: &mut ratatui::Frame) {
        let elapsed = self.rainbow_animation.elapsed();
        let bg_color = self.theme_bg_color();
    ...
    pub fn render_starfield_animation_in_area(&self, area: Rect, frame: &mut ratatui::Frame) {
        let elapsed = self.rainbow_animation.elapsed();
        let elapsed_ms = (elapsed * 1000.0) as u64;
        let bg_color = self.theme_bg_color();
    ...
    pub fn render_rain_animation_in_area(&self, area: Rect, frame: &mut ratatui::Frame) {
        let elapsed = self.rainbow_animation.elapsed();
        let elapsed_ms = (elapsed * 1000.0) as u64;
        let bg_color = self.theme_bg_color();
...
impl ChatApp {
    pub fn render_nyancat_animation_in_area(&self, area: Rect, frame: &mut ratatui::Frame) {
        let elapsed = self.rainbow_animation.elapsed();
        let elapsed_ms = (elapsed * 1000.0) as u64;
    ...
    pub fn render_dvdlogo_animation_in_area(&self, area: Rect, frame: &mut ratatui::Frame) {
        let elapsed = self.rainbow_animation.elapsed();
        let elapsed_ms = (elapsed * 1000.0) as u64;
        let bg_color = self.theme_bg_color();
    ...
    pub fn render_fire_animation_in_area(&self, area: Rect, frame: &mut ratatui::Frame) {
        let elapsed = self.rainbow_animation.elapsed();
        let elapsed_ms = (elapsed * 1000.0) as u64;
        let bg_color = self.theme_bg_color();
    ...
    pub fn render_plasma_animation_in_area(&self, area: Rect, frame: &mut ratatui::Frame) {
        let elapsed = self.rainbow_animation.elapsed();
        let t = elapsed * 10.0;
        let bg_color = self.theme_bg_color();
    ...
    pub fn render_spinners_animation_in_area(&self, area: Rect, frame: &mut ratatui::Frame) {
        let elapsed = self.rainbow_animation.elapsed();
    ...
    pub fn render_waves_animation_in_area(&self, area: Rect, frame: &mut ratatui::Frame) {
        let elapsed = self.rainbow_animation.elapsed();
        let bg_color = self.theme_bg_color();
    ...
    pub fn render_fireworks_animation_in_area(&self, area: Rect, frame: &mut ratatui::Frame) {
        let elapsed = self.rainbow_animation.elapsed();
        let elapsed_ms = (elapsed * 1000.0) as u64;
        let bg_color = self.theme_bg_color();
